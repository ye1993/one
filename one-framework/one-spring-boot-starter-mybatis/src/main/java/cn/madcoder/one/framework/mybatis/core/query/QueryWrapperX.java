package cn.madcoder.one.framework.mybatis.core.query;

import cn.hutool.core.lang.Assert;
import cn.madcoder.one.framework.mybatis.core.enums.SqlConstants;
...
public class QueryWrapperX<T> extends QueryWrapper<T> {
    ...
    public QueryWrapperX<T> likeIfPresent(String columns, String val) {
        if (StringUtils.hasText(val)) {
            return (QueryWrapperX<T>) super.like(columns, val);
        }
        return this;
    }

    public QueryWrapperX<T> eqIfPresent(String columns, String val) {
        if (StringUtils.hasText(val)) {
            return (QueryWrapperX<T>) super.eq(columns, val);
        }
        return this;
    }
