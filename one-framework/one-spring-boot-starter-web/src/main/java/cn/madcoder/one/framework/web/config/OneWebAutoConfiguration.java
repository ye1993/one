package cn.madcoder.one.framework.web.config;
...
import cn.madcoder.one.framework.web.core.filter.CacheRequestBodyFilter;
import cn.madcoder.one.framework.web.core.handler.GlobalExceptionHandler;
import cn.madcoder.one.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class OneWebAutoConfiguration implements WebMvcConfigurer {
