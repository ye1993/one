package cn.madcoder.one.framework.operatelog.core.aop;
...
import cn.madcoder.one.framework.operatelog.core.enums.OperateTypeEnum;
...
import static cn.madcoder.one.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
...
public class OperateLogAspect {
     ...
     * 用于记录操作内容的上下文
     *
     * @see cn.madcoder.one.framework.operatelog.core.service.OperateLog#getContent()
     */
    private static final ThreadLocal<String> CONTENT = new ThreadLocal<>();
    /**
     * 用于记录拓展字段的上下文
     *
     * @see cn.madcoder.one.framework.operatelog.core.service.OperateLog#getExts()
     */
    ...
    private Object around0(ProceedingJoinPoint joinPoint,OperateLog operateLog , Operation operation) throws Throwable {
    ...
    private void log0(ProceedingJoinPoint joinPoint,
                      ...
                      Operation operation,
                      LocalDateTime startTime, Object result, Throwable exception){
        cn.madcoder.one.framework.operatelog.core.service.OperateLog operateLogObj = new cn.madcoder.one.framework.operatelog.core.service.OperateLog();
    ...
    private static void fillMethodFields(cn.madcoder.one.framework.operatelog.core.service.OperateLog operateLogObj,
    ...
    private static void fillRequestFields(cn.madcoder.one.framework.operatelog.core.service.OperateLog operateLogObj) {
        // 获得 Request 对象
    ...
    private static void fillModuleFields(cn.madcoder.one.framework.operatelog.core.service.OperateLog operateLogObj,
                                         ProceedingJoinPoint joinPoint,
                                         OperateLog operateLog,
                                         Operation operation) {
        // module 属性
    ...
    private static void fillUserFields(cn.madcoder.one.framework.operatelog.core.service.OperateLog operateLogObj) {
    ...
    private static RequestMethod obtainFirstLogRequestMethod(RequestMethod[] requestMethods){
        ...
        return Arrays.stream(requestMethods).filter(requestMethod ->
                ...
                || requestMethod == RequestMethod.DELETE).findFirst().orElse(null);
    }
