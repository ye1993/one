package cn.madcoder.one.framework.sms.core.client.impl.tencent;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.StrUtil;
import cn.madcoder.one.framework.common.core.KeyValue;
import cn.madcoder.one.framework.common.util.collection.ArrayUtils;
...
import cn.madcoder.one.framework.sms.core.client.dto.SmsReceiveRespDTO;
import cn.madcoder.one.framework.sms.core.client.dto.SmsSendRespDTO;
import cn.madcoder.one.framework.sms.core.client.dto.SmsTemplateRespDTO;
import cn.madcoder.one.framework.sms.core.client.impl.AbstractSmsClient;
import cn.madcoder.one.framework.sms.core.enums.SmsTemplateAuditStatusEnum;
...
import static cn.madcoder.one.framework.common.util.date.DateUtils.FORMAT_YEAR_MONTH_DAY_HOUR_MINUTE_SECOND;
import static cn.madcoder.one.framework.common.util.date.DateUtils.TIME_ZONE_DEFAULT;
...
public class TencentSmsClient extends AbstractSmsClient {
    ...
    <Q, P, R> SmsCommonResult<R> invoke(Supplier<Q> requestSupplier,
        ...
        // 构建请求body
        Q request = requestSupplier.get();   //get的才执行方法
        P response;
        // 调用腾讯云发送短信

        try {
            response = responseSupplier.apply(request);     //SdkFunction为了接受异常
