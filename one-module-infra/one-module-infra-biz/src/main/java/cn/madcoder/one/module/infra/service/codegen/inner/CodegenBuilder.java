...
import cn.madcoder.one.module.infra.enums.codegen.CodegenColumnHtmlTypeEnum;
import cn.madcoder.one.module.infra.enums.codegen.CodegenColumnListConditionEnum;
import cn.madcoder.one.module.infra.enums.codegen.CodegenTemplateTypeEnum;
...
public class CodegenBuilder {
    ...
    private void processColumnExample(CodegenColumnDO column) {
        ...
        if (StrUtil.endWithIgnoreCase(column.getJavaField(), "name")) {
            column.setExample(randomEle(new String[]{"张三", "李四", "王五", "赵六", "one"}));
            return;
        }
        // status
