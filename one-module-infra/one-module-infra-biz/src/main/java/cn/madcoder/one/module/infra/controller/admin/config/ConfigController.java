package cn.madcoder.one.module.infra.controller.admin.config;
...
import cn.madcoder.one.module.infra.controller.admin.config.vo.*;
import cn.madcoder.one.module.infra.convert.config.ConfigConvert;
import cn.madcoder.one.module.infra.dal.dataobject.config.ConfigDO;
import cn.madcoder.one.module.infra.enums.ErrorCodeConstants;
import cn.madcoder.one.module.infra.service.config.ConfigService;
...
public class ConfigController {
    ...
    @Parameter(name = "key", description = "参数键", required = true, example = "one.biz.username")
