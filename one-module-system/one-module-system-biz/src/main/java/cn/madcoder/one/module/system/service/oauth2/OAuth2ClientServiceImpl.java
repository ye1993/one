...
import cn.madcoder.one.module.system.convert.oauth2.OAuth2ClientConvert;
import cn.madcoder.one.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import cn.madcoder.one.module.system.dal.mysql.oauth2.OAuth2ClientMapper;
...
public class OAuth2ClientServiceImpl implements OAuth2ClientService{
    ...
    public Long createOAuth2Client(OAuth2ClientCreateReqVO createReqVO) {
        ...
        clientMapper.insert(oauth2Client);
    ...
    void validateClientIdExists(Long id, String clientId) {
        OAuth2ClientDO client = clientMapper.selectByClientId(clientId);
        if (client == null) {
            return;
        }
