package cn.madcoder.one.module.system.controller.admin.logger;
...
import cn.madcoder.one.module.system.controller.admin.logger.vo.loginlog.LoginLogExportReqVO;
import cn.madcoder.one.module.system.controller.admin.logger.vo.loginlog.LoginLogPageReqVO;
import cn.madcoder.one.module.system.controller.admin.logger.vo.loginlog.LoginLogRespVO;
import cn.madcoder.one.module.system.convert.logger.LoginLogConvert;
...
public class LoginLogController {
    ...
    public CommonResult<PageResult<LoginLogRespVO>> getLoginLogPage(@Valid LoginLogPageReqVO reqVO) {
        ...
        return success(LoginLogConvert.INSTANCE.convertPage(page));
    }
