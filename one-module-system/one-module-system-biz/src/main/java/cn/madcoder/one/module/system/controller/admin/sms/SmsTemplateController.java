...
import cn.madcoder.one.module.system.service.sms.SmsTemplateService;
...
public class SmsTemplateController {
    ...
    public CommonResult<PageResult<SmsTemplateRespVO>>  getSmsTemplatePage(@Valid SmsTemplatePageReqVO pageVO) {
        ...
        return success(SmsTemplateConvert.INSTANCE.convertPage(smsTemplateService.getSmsTemplatePage(pageVO)));
    }
