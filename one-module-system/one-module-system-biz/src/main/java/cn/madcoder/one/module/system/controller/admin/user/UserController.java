...
import cn.madcoder.one.module.system.enums.common.SexEnum;
...
public class UserController {
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<UserImportExcelVO> list = Arrays.asList(
                UserImportExcelVO.builder().username("one").deptId(1L).email("one@madcoder.cn").mobile("15601111300")
                        .nickname("one").status(CommonStatusEnum.ENABLE.getStatus()).sex(SexEnum.MAN.getSex()).build(),
                UserImportExcelVO.builder().username("one2").deptId(2L).email("yuanma@iocoder.cn").mobile("15601701333")
