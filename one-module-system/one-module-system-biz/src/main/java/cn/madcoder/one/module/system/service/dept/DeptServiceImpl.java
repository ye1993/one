...
import cn.madcoder.one.module.system.dal.mysql.dept.DeptMapper;
import cn.madcoder.one.module.system.dal.redis.RedisKeyConstants;
import cn.madcoder.one.module.system.enums.dept.DeptIdEnum;
...
public class DeptServiceImpl implements DeptService {
    ...
    @Override
//    @DataPermission(enable = false) // 禁用数据权限，避免不正确的缓存
